      ...
      <ScrollArea className="tw-min-h-0 tw-flex-1">
        <div className="tw-flex tw-flex-col tw-gap-6 tw-p-4">
          ...
          <div className="tw-rounded-lg tw-border tw-border-border tw-p-4 tw-bg-secondary/50">
            <h3 className="tw-mb-3 tw-text-sm tw-font-medium tw-text-normal">基本信息</h3>
            <div className="tw-flex tw-flex-col tw-gap-3">
              <FormField
                label="项目名称"
                required
                error={touched.name && !formData.name}
                errorMessage="项目名称为必填项"
              >
                <Input
                  type="text"
                  value={formData.name}
          ...
          <div className="tw-rounded-lg tw-border tw-border-border tw-p-4 tw-bg-secondary/50">
            <h3 className="tw-mb-3 tw-text-sm tw-font-medium tw-text-normal">上下文来源</h3>
