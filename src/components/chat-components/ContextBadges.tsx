...
export function ContextActiveNoteBadge({
  ...
  return (
    ...
    >
      ...
      <span className="tw-text-xs tw-text-faint">当前</span>
...
export function ContextActiveWebTabBadge({
  ...
  const displayText = activeWebTab.title || domain || activeWebTab.url || "无标题";
...
export function ContextWebTabBadge({ webTab, onRemove, onClick }: ContextWebTabBadgeProps) {
  ...
  const displayText = webTab.title || domain || webTab.url || "无标题";
  ...
  return (
    ...
    >
      ...
      {!isLoaded && <span className="tw-text-xs tw-text-muted">（未加载）</span>}
    </ContextBadgeWrapper>
  );
}
  ...
  if (isWebSelectedTextContext(selectedText)) {
    ...
    return (
      ...
      >
        ...
        <span className="tw-text-xs tw-text-faint">选区</span>
      </ContextBadgeWrapper>
    );
  }
