...
const AGENT_DEFAULT_LABEL = "智能体默认";
const EFFORT_NOT_SUPPORTED_LABEL = "不支持";
...
export const AgentDefaultModelSetting: React.FC<Props> = ({ descriptor, manager }) => {
  ...
  const modelOptions = defaultMissingFromEnabled
    ? [
        ...
        { label: `${current?.baseModelId}（已禁用）`, value: selectedBaseId },
        ...enabledOptions,
      ]
  ...
  return (
    <>
      <SettingItem
        type="select"
        title="默认模型"
        description="用于此智能体的新建对话和多智能体回答。已打开的对话将在下一轮切换。"
