...
const STATUS_BADGES: Partial<Record<AgentSelectStatus, StatusBadgeSpec>> = {
  checking: { label: "正在检查…", variant: "secondary", Icon: LoaderCircle },
  installed: { label: "已安装", variant: "success", Icon: Check },
  outdated: { label: "需要更新", variant: "destructive", Icon: AlertTriangle },
            ...
            >
              ...
              <span className="tw-flex tw-min-w-0 tw-flex-1 tw-flex-col tw-gap-1">
                <span className="tw-flex tw-flex-wrap tw-items-center tw-gap-1.5">
                  ...
                  {row.recommended && <Badge variant="accent">推荐</Badge>}
                </span>
