  ...
  return (
    <div className="tw-px-3 tw-py-2.5">
      <div className="tw-mb-1.5 tw-flex tw-items-baseline tw-justify-between">
        <span className="tw-text-ui-smaller tw-font-semibold tw-text-faint">进度</span>
  ...
  return (
    <div className="tw-px-3 tw-py-2.5">
      <div className="tw-mb-1 tw-flex tw-items-center tw-justify-between">
        <span className="tw-text-ui-smaller tw-font-semibold tw-text-faint">项目文件</span>
        <Button
          variant="ghost2"
          size="icon"
          aria-label="在仓库中显示项目文件"
      ...
      >
        ...
        <span className="tw-text-ui-small tw-font-medium">输出</span>
        <span className="tw-text-ui-smaller tw-text-faint">(0)</span>
      </div>
      {outputsOpen && (
        <div className="tw-py-1 tw-pl-6 tw-text-ui-smaller tw-text-faint">暂无输出</div>
      )}
    </div>
  );
}
