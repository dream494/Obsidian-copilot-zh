...
export function buildStatusView(
  ...
  if (!entry || entry.phase === "idle") {
    ...
    return { kind: "idle", headline: "未加载上下文", steps: [], failures: [] };
  }
