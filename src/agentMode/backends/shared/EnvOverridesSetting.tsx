  ...
  return (
    <div className="tw-flex tw-flex-col tw-gap-2 tw-py-4">
      <div className="tw-flex tw-flex-col tw-gap-1">
        <div className="tw-text-sm tw-font-medium tw-leading-none">环境变量</div>
        <div className="tw-text-xs tw-text-muted">
          为 {backendDisplayName} 设置环境变量，例如 <code>{hintA}</code> 或 <code>{hintB}</code>。
        </div>
      </div>
      <div className="tw-flex tw-w-full tw-flex-col tw-gap-2">
        ...
        <Button variant="ghost2" size="sm" className="tw-self-start" onClick={addRow}>
