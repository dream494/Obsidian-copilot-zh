    ...
    <div className="tw-flex tw-flex-col tw-gap-4 tw-p-4">
      ...
      <div className="tw-flex tw-items-start tw-gap-2 tw-rounded-md tw-border tw-border-solid tw-border-border tw-p-4 tw-text-muted">
        ...
        <div className="tw-flex-1">
          系统提示词会自动从系统提示词文件夹中的 .md 文件加载{" "}
          <strong>{deriveSystemPromptsFolder(settings)}</strong>。修改这些文件也会更新系统提示词设置。
        </div>
      </div>
      ...
      <div className="tw-flex tw-flex-col tw-gap-2">
        ...
        <div className="tw-relative">
          <Textarea
            id="content"
            placeholder="在此输入你的系统提示词…使用 {[[Note Name]]} 包含笔记内容。"
