      ...
      if (category === "cli") {
        ...
        return (
          ...
          >
            <SettingItem
              type="switch"
              title="Obsidian CLI（实验性）"
              description="通过 Obsidian 桌面 CLI 启用直接的仓库操作"
              checked={allEnabled}
  ...
  return (
    <>
      <SettingItem
        type="slider"
        title="最大迭代次数"
        description="自主智能体可以执行的最大推理迭代次数。更高的值允许更复杂的推理，但可能耗时更长。"
      ...
      <div className="tw-mt-4 tw-rounded-lg tw-bg-secondary tw-p-4">
        <div className="tw-mb-2 tw-text-sm tw-font-medium">智能体可访问的工具</div>
