...
Obsidian 的 i18n 翻译插件(社区常用的界面汉化方案)在 **Copilot V4** 上不可用——启用会导致插件崩溃/异常,无法用插件翻译官方版界面,官方 V4 也不自带中文。

所以干脆自己动手:用 vibe coding 方式对官方 4.0.2 的全部界面文本做 AI 批量汉化,并在**不改一行业务逻辑**的前提下打成本仓库。装上即可用,与官方版并存互不干扰。
